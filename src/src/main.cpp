...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        if (command == "run") {
            ...
            Runner runner(supported_models, downloader, tag, asr, ctx_length, preemption);
            runner.run();
            ...
            auto server = create_lm_server(supported_models, downloader, tag, asr, port, ctx_length, cors, preemption);
